        ...
        <div class="collapse navbar-collapse" id="navLinks">
          ...
          <ul class="navbar-nav ml-auto">
            <c:if test="${empty sessionScope.userName}">
              ...
              <li class="nav-item"><a class="nav-link " href="join">Signup</a></li>
            </c:if>


            <c:if test="${!empty sessionScope.userName}">
              <c:choose>
                <c:when test="${sessionScope.matchingAlert > 0}">
                  <li class="nav-item"><a class="nav-link" href="incomingRequest.do"><i class="fas fa-bell"></i></a>
                  </li>
                </c:when>
              </c:choose>
              <li class="nav-item"><a class="nav-link" href="myPage.do">
                  Welcome, ${sessionScope.userName}!</a></li>
              <li class="nav-item"><a class="nav-link" href="myPageDetailProcess.do"> <i class=" fas
                    fa-comment-alt"></i></a></li>
              <li class="nav-item"><a class="nav-link" href="logout.do"> <i class="fas fa-power-off"></i></a>
              </li>
            </c:if>
          </ul>
        </div>
